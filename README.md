<img src="http://assets.angular.schule/logo-angular-schulung-heidelberg-2018-09.png">

#### **mit Johannes Hoppe**

[![Join the chat at https://gitter.im/2018-09-angular-workshop-heidelberg/Lobby](https://badges.gitter.im/2018-09-angular-workshop-heidelberg/Lobby.svg)](https://gitter.im/2018-09-angular-workshop-heidelberg/Lobby?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
> **https://github.com/angular-schule/2018-09-angular-workshop-heidelberg**
...
5. **Git**: [https://git-scm.com/](https://git-scm.com/) (optional, aber sehr hilfreich) und ggf. ein grafischer Client wie SourceTree oder GitExtensions
...
```
npm install -g @angular/cli@7.0.0-beta.2
```
